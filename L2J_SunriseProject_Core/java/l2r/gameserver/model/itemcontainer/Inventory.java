...
public abstract class Inventory extends ItemContainer
{
	...
	public int getPaperdollItemId(int slot)
	{
		...
		{
			if ((slot == PAPERDOLL_RHAND) && getOwner().getActingPlayer().isInAirShip() && getOwner().getActingPlayer().getAirShip().isCaptain(getOwner().getActingPlayer()))
			{
				return 13556; // A plug for displaying the steering wheel - Airship Helm
			}
		}
