...
public final class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(_activeChar.getSunriseVariables().getVarI("donate_race", -1) >= 0 ? _activeChar.getSunriseVariables().getVarI("donate_race", 0) : _activeChar.getRace().ordinal());
		writeD(_activeChar.getAppearance().getSex() ? 1 : 0);
		writeD(_activeChar.getSunriseVariables().getVarI("donate_class", -1) >= 0 ? _activeChar.getSunriseVariables().getVarI("donate_class", 0) : _activeChar.getBaseClass());
		...
		writeF(_activeChar.getSunriseVariables().getVarI("donate_class", 0) > 0 ? PlayerTemplateData.getInstance().getTemplate(_activeChar.getSunriseVariables().getVarI("donate_class", 0)).getCollisionRadius() : _activeChar.getCollisionRadius());
		writeF(_activeChar.getSunriseVariables().getVarI("donate_class", 0) > 0 ? PlayerTemplateData.getInstance().getTemplate(_activeChar.getSunriseVariables().getVarI("donate_class", 0)).getCollisionHeight() : _activeChar.getCollisionHeight());
