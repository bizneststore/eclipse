...
import l2r.features.rankPvpSystem.RankPvpSystem;
...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		AIOBufferManager.onEnterAio(activeChar);
		...
		for (L2ItemInstance item : activeChar.getInventory().getItems())
		{
			...
			if (item.isEnergyItem() && item.isEquipped())
			{
		...
		activeChar.setEnterWorldLocation(activeChar.getLocation());
