...
public final class Config extends AbstractConfigs
{
	...
	public static boolean ALT_OLY_CALCULATE_SUMMON_DAMAGE;
	...
	public static boolean ZIG_ZAG_MOVEMENT;
	...
	public void loadConfigs()
	{
		if (Server.serverMode == Server.MODE_GAMESERVER)
		{
			...
			ZIG_ZAG_MOVEMENT = NPC.getBoolean("ZigZagMovement", true);
			...
			ALT_OLY_CALCULATE_SUMMON_DAMAGE = Olympiad.getBoolean("AltOlyCalculateSummonDamage", true);
			...
			GEOFILES_FORMAT = Geodata.getInt("GeoFilesFormat", 1);
			...
			ALLOW_KEYBOARD_MOVE = Geodata.getBoolean("AllowMoveWithKeyboard", true);
			...
			NPC_PATH_FIND_MAX_HEIGHT = Geodata.getInt("NPCPathFindMaxHeight", 1024);
			PLAYABLE_PATH_FIND_MAX_HEIGHT = Geodata.getInt("PLAYABLEPathFindMaxHeight", 256);
