...
public abstract class AbstractAI implements Ctrl
{
	...
	{
		moveTo(followTarget.getLocation2(), _range);
	}
	...
	public final void setIntention(CtrlIntention intention, Object arg0, Object arg1)
	{
		...
		switch (intention)
		{
			...
			case AI_INTENTION_MOVE_TO:
				onIntentionMoveTo((Location) arg0, arg1 != null ? (boolean) (arg1) : false);
				break;
	...
	protected abstract void onIntentionMoveTo(Location destination, boolean keyboard);
	 ...
	 * @param keyboard
	 */
	protected void moveTo(int x, int y, int z, int offset, boolean keyboard)
	{
		_actor.moveToLocation(x, y, z, offset, keyboard);
	}
	...
	{
		// Do not allow attack mode in dead actors
		if (isAutoAttacking && _actor.isDead())
		{
			return;
		}
	...
	{
		// Dead characters does not have attack animation
		if (_actor.isDead())
		{
			// Log.info("clientStartAutoAttack with invalid conditions: " + _actor, new IllegalArgumentException());
			return;
		}
