...
public abstract class L2Skill implements IChanceSkillTrigger, IIdentifiable
{
	 ...
	 * @param env
	 */
	public final void getEffectsVoid(L2Character effector, L2Character effected, Env env)
	{
		// vGodFather: this will prevent debuffs apply on dead characters
		if (effected == null)
		{
	 ...
	 * @param effected
	 */
	public final void applyEffects(L2Character effector, L2Character effected)
	{
		getEffectsVoid(effector, effected, null);
	}
	...
	public final void getEffectsPassive(L2Character effector)
	{
