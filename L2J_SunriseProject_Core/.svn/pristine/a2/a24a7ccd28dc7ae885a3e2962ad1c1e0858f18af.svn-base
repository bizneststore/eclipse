...
public final class SystemMessageId
{
	 ...
	 */
	public static final SystemMessageId YOU_CANNOT_CONTROL_THE_HELM_BECAUSE_YOU_DO_NOT_MEET_THE_REQUIREMENTS = new SystemMessageId(2739);
	
	/**
	 * ID: 2740<br>
	 * Message: Unavailable while steering.
	 */
	public static final SystemMessageId UNAVAILABLE_WHILE_STEERING = new SystemMessageId(2740);
	...
	public static final SystemMessageId THE_PREMIUM_ITEM_CANNOT_BE_RECEIVED_BECAUSE_THE_INVENTORY_WEIGHTQUANTITY_LIMIT_HAS_BEEN_EXCEEDED = new SystemMessageId(6047);
