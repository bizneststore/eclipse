...
import l2r.gameserver.model.actor.instance.L2BackupPowerUnitInstance;
import l2r.gameserver.model.actor.instance.L2DoorInstance;
import l2r.gameserver.model.actor.instance.L2FortCommanderInstance;
import l2r.gameserver.model.actor.instance.L2PcInstance;
import l2r.gameserver.model.actor.instance.L2PowerControlUnitInstance;
...
public class FortSiege implements Siegable
{
	...
	protected List<L2Spawn> _powerUnits;
	protected List<L2Spawn> _controlUnits;
	protected List<L2Spawn> _mainMachines;
	
	private boolean _isControlDisabled;
	private boolean _isControlDoorsOpen;
	...
	public FortSiege(Fort fort)
	{
		...
		this._powerUnits = new CopyOnWriteArrayList<>();
		this._controlUnits = new CopyOnWriteArrayList<>();
		this._mainMachines = new CopyOnWriteArrayList<>();
	...
	public void killedControlUnit(final L2BackupPowerUnitInstance instance)
	{
	...
	public void killedPowerUnit(final L2PowerControlUnitInstance instance)
	{
	...
	public void checkCommanders()
	{
		if (this._commanders.isEmpty() && this._isControlDisabled)
		{
			...
			for (final L2DoorInstance door : this.getFort().getDoors())
			{
				if (door.getIsShowHp())
				{
					continue;
	...
	private void removePowerUnits()
	{
		...
		{
			for (final L2Spawn spawn : this._powerUnits)
			{
				if (spawn != null)
				{
					spawn.stopRespawn();
	...
	private void removeControlUnits()
	{
		...
		{
			for (final L2Spawn spawn : this._controlUnits)
			{
				if (spawn != null)
				{
					spawn.stopRespawn();
	...
	private void removeMainMachine()
	{
		...
		{
			for (final L2Spawn spawn : this._mainMachines)
			{
				if (spawn != null)
				{
					spawn.stopRespawn();
	...
	{
		final List<FortSiegeSpawn> spawns = FortSiegeManager.getInstance().getControlUnitSpawnList(this.getFort().getResidenceId());
		...
		{
			this._controlUnits.clear();
			for (final FortSiegeSpawn _sp : spawns)
			{
				final L2NpcTemplate template1 = NpcTable.getInstance().getTemplate(_sp.getId());
				if (template1 != null)
				{
	...
	{
		final List<FortSiegeSpawn> spawns = FortSiegeManager.getInstance().getPowerUnitSpawnList(this.getFort().getResidenceId());
		if ((spawns == null) || spawns.isEmpty())
		{
			return;
		}
	...
	{
		final List<FortSiegeSpawn> spawns = FortSiegeManager.getInstance().getMainMachineSpawnList(this.getFort().getResidenceId());
		if ((spawns == null) || spawns.isEmpty())
		{
			return;
		}
	...
	public List<L2Spawn> getControlUnits()
	{
		return this._controlUnits;
	}
	
	public List<L2Spawn> getPowerUnits()
	{
		return this._powerUnits;
	}
	
	public List<L2Spawn> getMainMachine()
	{
		return this._mainMachines;
	}
	
	public void setOpenControlDoors(final boolean open)
	{
	...
	public void openControlDoors(final int id)
	{
		switch (id)
		{
			case 102:
			{
				DoorData.getInstance().getDoor(19240003).openMe();
				DoorData.getInstance().getDoor(19240004).openMe();
				break;
			}
			case 104:
			{
				DoorData.getInstance().getDoor(23210002).openMe();
				DoorData.getInstance().getDoor(23210003).openMe();
				break;
			}
			case 107:
			{
				DoorData.getInstance().getDoor(25190002).openMe();
				DoorData.getInstance().getDoor(25190003).openMe();
				break;
			}
			case 109:
			{
				DoorData.getInstance().getDoor(24150009).openMe();
				DoorData.getInstance().getDoor(24150010).openMe();
				break;
			}
			case 110:
			{
				DoorData.getInstance().getDoor(22160002).openMe();
				DoorData.getInstance().getDoor(22160003).openMe();
				break;
			}
			case 112:
			{
				DoorData.getInstance().getDoor(20220017).openMe();
				DoorData.getInstance().getDoor(20220018).openMe();
				break;
			}
			case 113:
			{
				DoorData.getInstance().getDoor(18200004).openMe();
				DoorData.getInstance().getDoor(18200005).openMe();
				break;
			}
			case 116:
			{
				DoorData.getInstance().getDoor(22200010).openMe();
				DoorData.getInstance().getDoor(22200011).openMe();
				break;
			}
			case 117:
			{
			...
			case 118:
			{
				DoorData.getInstance().getDoor(23200004).openMe();
				DoorData.getInstance().getDoor(23200005).openMe();
				break;
			}
		}
	...
	public void disablePower(final boolean disable)
	{
