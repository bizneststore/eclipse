...
public final class NpcHtmlMessage extends AbstractHtmlPacket
{
	...
	public void replaceNpcString(final String pattern, final NpcStringId npcString, final Object... arg)
	{
		if (pattern == null)
		{
			return;
		...
		setHtml(getHtml().replaceAll(pattern, HtmlUtil.htmlNpcString(npcString, arg)));
	}
