...
import l2.gameserver.network.pfilter.IFPacketFilter;
 ...
 * @author KenM
 */
public class L2GameClient extends MMOClient<MMOConnection<L2GameClient>> implements IFPacketFilter
{
	...
	private final PacketFilter _packetFilter;
	...
	public L2GameClient(MMOConnection<L2GameClient> con)
	{
		...
		this._packetFilter = PacketFilter.create(this);
	}
