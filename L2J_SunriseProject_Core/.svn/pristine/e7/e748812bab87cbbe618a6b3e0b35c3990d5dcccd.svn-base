...
public final class Say2 extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (EventDispatcher.getInstance().hasListener(EventType.ON_PLAYER_CHAT, activeChar))
		{
		...
		if (handler != null)
		{
			if (AutobotsManager.INSTANCE.onChat(_type, activeChar, _target, _text, handler))
			{
				return;
			}
