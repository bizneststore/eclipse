...
public class CharStatus
{
	...
	{
		if ((!RegenTaskManager.getInstance().isScheduled(getActiveChar())) && !getActiveChar().isDead())
		{
			// Get the Regeneration period
			// Create the HP/MP/CP Regeneration task
			RegenTaskManager.getInstance().add(getActiveChar());
		}
	}
	...
	{
		RegenTaskManager.getInstance().cancel(getActiveChar());
