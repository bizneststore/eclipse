...
public class L2SkillDrain extends L2Skill
{
	...
	public void useSkill(L2Character activeChar, L2Object[] targets)
	{
		...
		for (L2Character target : (L2Character[]) targets)
		{
			...
			final double mAtk = activeChar.getMAtk(target, this);
			int damage = isStaticDamage() ? (int) getPower() : (int) Formulas.calcMagicDam(activeChar, target, this, mAtk, shld, sps, bss, mcrit);
