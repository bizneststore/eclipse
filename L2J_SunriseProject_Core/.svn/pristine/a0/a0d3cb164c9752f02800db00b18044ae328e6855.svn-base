...
public final class Broadcast
{
	...
	public static void toKnownPlayersInRadius(L2Character character, int radius, L2GameServerPacket... mov)
	{
		if (radius < 0)
		{
			radius = 600;
		...
		final Collection<L2PcInstance> plrs = character.getKnownList().getKnownPlayersInRadius(radius);
		for (L2PcInstance player : plrs)
		{
